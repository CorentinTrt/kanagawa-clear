...
function M.setup(colors, config)
    ...
    return {
        ...
        CursorLineNr = { fg = theme.diag.warning, bg = "NONE", bold = true },
        ...
        DiagnosticSignError = { fg = theme.diag.error, bg = "NONE" },
        DiagnosticSignWarn = { fg = theme.diag.warning, bg = "NONE" },
        DiagnosticSignInfo = { fg = theme.diag.info, bg = "NONE" },
        DiagnosticSignHint = { fg = theme.diag.hint, bg = "NONE" },
